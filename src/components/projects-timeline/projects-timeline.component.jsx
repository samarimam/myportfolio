                  ...
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        ...
                        Keep track on covid-19 cases all over the world.
                        <hr />
                        ...
                        <ul className="list-styles pt-1">
                          ...
                          <li>
                            Can be installed in Android phones using Progressive
                            web apps{" "}
                          </li>
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This is a blog website
                        where you can write blogs and store images.It is fully
                        authenticated and uses realtime database.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>User information is stored in MongoDb datbase</li>
                          <li>Authenticated with octa authentication</li>
                          <li>
                            Blogs can be updated and and filtered y categories
                          </li>
                        </ul>
                        <hr />
                        <strong>Tech used:</strong>
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This app has user
                        authentication with fiebase.You can make posts and share
                        ...
                        <ul className="list-styles pt-1">
                          ...
                          <li>
                            For frontend react is used and for backend firebase
                            is used.
                          </li>
                        </ul>
                        <hr />
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This app is a donation
                        webapp. It has a payment integrated gateway.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This is a fully
                        authenticated todolist with realtime database where
                        users information and notes are encrypted and stored.It
